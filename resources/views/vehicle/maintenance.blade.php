    ...
    <div style="width: 100%">
        ...
        <main>
            <table class="table-bordered" style="width:100%">
                ...
                <tbody>
                    @foreach ($item->maintenance as $booking)
                        <tr class="text-align:center">
                            <td><center>{{ \Carbon\Carbon::parse($booking->created_at)->format('M d, Y') }}</center></td>
                            <td><center>{{ \Carbon\Carbon::parse($booking->Date)->format('M d, Y') }}</center></td>
                            <td><center>{{ $booking->type_of_maintenance }}</center></td>
                            <td><center>{{$booking->price}}</center></td>
                        </tr>
                    @endforeach
